                ...
                <div class="divide-y divide-gray-200">
                    <form wire:submit.prevent="edit">
                        <div class="py-8 space-y-4 text-base leading-6 text-gray-700 sm:text-lg sm:leading-7">
                            <div class="relative">
                                <input wire:model.lazy="name" value="name" id="Book" name="Book" type="text" class="w-full h-10 text-gray-900 placeholder-transparent border-0 border-b-2 border-gray-300 peer focus:outline-none " placeholder="Book Name" />
                            ...
                            <div class="relative">
                                <textarea wire:model.lazy="description" value="" id="description" name="description" type="description" class="w-full h-10 text-gray-900 placeholder-transparent border-0 border-b-2 border-gray-300 peer focus:outline-none " placeholder="Description" />
                                </textarea>
                            ...
                            <div class="  flex justify-center ">
                                ...
                                <input wire:model.lazy="new_image" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file">
                                </div>
                            </div>
                            <div class="relative">
